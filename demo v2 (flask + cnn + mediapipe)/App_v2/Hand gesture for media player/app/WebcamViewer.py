...
class WebcamViewer(QMainWindow):
    ...
    def init_ui(self) -> None:
        ...
        default_shortcuts = {
            "Gesture 0": "Play/Pause - space",
            "Gesture 1": "Next - ctrl right",
            "Gesture 2": "Back - ctrl left",
            "Gesture 3": "Vol up - ctrl up",
            "Gesture 4": "Vol down - ctrl down",
            "Gesture 5": "Repeat - ctrl R",
        }
